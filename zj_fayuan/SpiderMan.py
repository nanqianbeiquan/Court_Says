...
class SpiderMan(object):
    ...
    def __init__(self, order, keep_session=True, keep_ip=False, max_try_times=6, headers={'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.11; rv:45.0) Gecko/20100101 Firefox/45.0'}):
        self.order = order
